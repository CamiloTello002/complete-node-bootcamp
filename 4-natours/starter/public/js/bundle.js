...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); // in order to use removeChild, you need its parent element
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error logging out! Please try again'); // console.log(err.response);
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          dataUpdate = type === 'password' ? 'updatePassword' : 'updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/api/v1/users/".concat(dataUpdate),
            data: data // data: {
            //   name,
            //   email,
            // },
